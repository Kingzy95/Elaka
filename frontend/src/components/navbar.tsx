                ...
                <div className="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 lg:py-4">
                    <div className="relative z-20 flex w-full justify-between md:px-0 lg:w-max">
                        ...
                        >
                            <div aria-hidden="true"
                                 className={`m-auto h-0.5 w-5 rounded bg-sky-900 transition duration-300 dark:bg-gray-300 ${isMobileMenuOpen ? 'rotate-45 translate-y-1.5' : ''}`}/>
                            <div aria-hidden="true"
                                 className={`m-auto mt-2 h-0.5 w-5 rounded bg-sky-900 transition duration-300 dark:bg-gray-300 ${isMobileMenuOpen ? '-rotate-45 -translate-y-1' : ''}`}/>
                        </button>
                    </div>
                    <div
                        id="layer"
                        aria-hidden="true"
                        className={`fixed inset-0 z-10 h-screen w-screen bg-white/70 backdrop-blur-2xl transition duration-500 dark:bg-gray-900/70 lg:hidden ${isMobileMenuOpen ? 'scale-y-100' : 'scale-y-0'}`}
                    >
                    </div>
                    <div
                        id="navlinks"
                        className={`absolute top-full left-0 z-20 w-full origin-top-right flex-col flex-wrap justify-end gap-6 rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10 transition-all duration-300 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none lg:visible lg:relative lg:flex lg:w-auto lg:translate-y-0 lg:scale-100 lg:flex-row lg:items-center lg:gap-0 lg:border-none lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none lg:peer-checked:translate-y-0 dark:lg:bg-transparent
                                ${isMobileMenuOpen ? 'visible translate-y-0 scale-100 opacity-100' : 'invisible translate-y-1 scale-90 opacity-0'}
                    ...
                    >
                        ...
                        <div className="mt-12 -ml-1 flex w-full flex-col space-y-2 border-primary/10 dark:border-gray-700 sm:flex-row md:w-max lg:mt-0 lg:mr-6 lg:space-y-0 lg:border-l lg:pl-6">
                            <a href="/" className="relative ml-auto flex h-9 w-full items-center justify-center before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-primaryLight sm:px-4 lg:before:border lg:before:border-gray-200 lg:before:bg-gray-100 lg:dark:before:bg-gray-800">
                        ...
                        >
                            {theme === 'dark' ? (
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="transistion relative m-auto h-5 w-5 fill-gray-500 duration-300 group-hover:rotate-180 group-hover:fill-yellow-400 dark:fill-gray-300"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="transistion relative m-auto h-5 w-5 fill-gray-500 duration-300 group-hover:-rotate-90 group-hover:fill-blue-900"
                                     viewBox="0 0 20 20" fill="currentColor">
