...
const FooterLink = ({href, children}) => (
    <li>
        <Link href={href} className="text-sm duration-100 hover:text-primary dark:hover:text-white">
            {children}
        </Link>
    </li>
);
...
const FooterColumn = ({title, links}) => (
    <div>
        ...
        <ul className="mt-4 list-inside space-y-4">
            {links.map((link: { href: any; text: any; }, index: Key | null | undefined) => (
    ...
    const columns = [
        {
            ...
            links: [
                ...
                { href: "/partenaires", text: "Partenaires de santé" },
                { href: "/carrieres", text: "Carrières" },
        ...
        },
        {
            title: "Services",
            links: [
                { href: "/rendez-vous", text: "Prise de rendez-vous" },
                { href: "/questions-sante", text: "Assistant IA santé" },
                { href: "/pharmacies", text: "Recherche de pharmacies" },
                { href: "/medicaments", text: "Disponibilité des médicaments" },
                { href: "/telemedecine", text: "Télémédecine" },
            ]
        },
        {
            title: "Ressources",
            links: [
                { href: "/blog", text: "Blog santé" },
                { href: "/faq", text: "FAQ" },
                { href: "/tutoriels", text: "Tutoriels d'utilisation" },
                { href: "/confidentialite", text: "Politique de confidentialité" },
                { href: "/conditions", text: "Conditions d'utilisation" },
            ]
        }
    ];
                    ...
                    <div className="grid grid-cols-8 gap-6 md:gap-0">
                        <div className="col-span-8 md:col-span-2 lg:col-span-3">
                            <div className="flex h-full items-center justify-between gap-6 border-b border-white py-6 dark:border-gray-800 md:flex-col md:items-start md:justify-between md:space-y-6 md:border-none md:py-0">
                                <div>
                                    <Link href="/" aria-label="ampire logo" className="flex items-center">
                                        {/* SVG Logo */}
                                    ...
                                    <Link href="https://tailus.io" className="mt-2 inline-block text-sm">
                                        Développé par Elaka Tech
                                    </Link>
                                </div>
                        ...
                        <div className="col-span-8 md:col-span-6 lg:col-span-5">
                            ...
                            <div className="flex justify-between text-sm md:pl-16">
                                <span>&copy; ElakaTech AI 2023 - {new Date().getFullYear()}</span>
